...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2017 at 02:30 AM
...
--
-- Table structure for table `armoire_order`
--
...
--
-- Dumping data for table `armoire_order`
--
...
--
-- Table structure for table `armoire_order_item`
--
...
--
-- Dumping data for table `armoire_order_item`
--
...
(13, 2, 7, '2016-11-20/583110070fe59.jpg', '7777', '2016-11-20 02:52:55', '2016-11-20 02:52:55', 1, '未完成');

-- --------------------------------------------------------

--
-- Table structure for table `armoire_order_item_remark`
--
...
--
-- Dumping data for table `armoire_order_item_remark`
--
...
--
-- Table structure for table `armoire_user`
--
...
--
-- Dumping data for table `armoire_user`
--
...
(1, 'admin', 'e99a18c428cb38d5f260853678922e03', '2016-10-28 13:45:57', '2017-02-21 02:25:15', 1, '管理员', '2016-10-29 14:38:36'),
...
(12, 'qq', '099b3b060154898840f0ebdfb46ec78f', '2016-11-20 06:42:16', '2016-11-20 06:42:36', 3, 'qq', '2016-11-20 06:42:16');

-- --------------------------------------------------------

--
-- Table structure for table `armoire_user_group`
--
...
--
-- Dumping data for table `armoire_user_group`
--
...
--
-- AUTO_INCREMENT for table `armoire_order`
--
ALTER TABLE `armoire_order`
  MODIFY `uid` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `armoire_order_item`
--
ALTER TABLE `armoire_order_item`
  MODIFY `uid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `armoire_order_item_remark`
--
ALTER TABLE `armoire_order_item_remark`
  MODIFY `uid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT for table `armoire_user`
--
ALTER TABLE `armoire_user`
  MODIFY `uid` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
